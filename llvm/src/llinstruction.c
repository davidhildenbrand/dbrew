...
static const ConversionDescriptor descriptors[IT_Max] = {
    ...
    [IT_SETC] = CD_FUNCTION(ll_instruction_setcc),
    [IT_SETNC] = CD_FUNCTION(ll_instruction_setcc),
    [IT_SETZ] = CD_FUNCTION(ll_instruction_setcc),
    [IT_SETNZ] = CD_FUNCTION(ll_instruction_setcc),
